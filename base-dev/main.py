...
def main():
    ...
    try:
        commands = {
            "allCommand": {
                "clear": {"command": console.clear, "arguments": False},
                "?": {
                    "command": help.start_init,
                    "arguments": {"default": [False], "dev": True},
                },
                "debug": {
                    "command": error_and_log.debug_mode,
                    "arguments": {"default": [True], "o": True, "n": False},
                },
            }
        }
        ...
        while True:
            error_and_log.debug_test(
                function=function_name, my_file=fileName, number=0, condition="Initial"
            )
            ...
            if start:
                ...
                if console_input_split[0] in command:
                    ...
                    if command[console_input_split[0]]["arguments"]:
                        ...
                        if (
                            not command[console_input_split[0]]["arguments"]["default"]
                            and len(arguments) == 1
                        ):
                            error_and_log.debug_test(
                                function=function_name,
                            ...
                            arguments = command[console_input_split[0]]["arguments"][
                                "default"
                            ][0]
                            arguments_ok = True
                        else:
                            ...
                            for argumentsInput in arguments:
                                ...
                                if (
                                    argumentsInput
                                    in command[console_input_split[0]]["arguments"]
                                ):
                                    error_and_log.debug_test(
                                        function=function_name,
                                        my_file=fileName,
                                    ...
                                    arguments = command[console_input_split[0]][
                                        "arguments"
                                    ][argumentsInput]
                                    arguments_ok = True
                                    break
